...
| 参数名 | 必选 | 类型 | 说明 |
| :--- | :--- | :--- | --- |
| requestId | 是 | string | 客户请求标识,最长32位\(用户发起即时到账请求时，企业系统自动生成，每个requestId代表一个即时到账请求，工猫作为每笔即时到账的唯一标识\) |
...
| 参数名 | 必选 | 类型 | 说明 |
| :--- | :--- | :--- | --- |
| payProductCode | 是 | string | 支付产品码，64表示主扫-借记卡，65表示主扫-综合，66表示公众号/小程序/服务窗-借记卡，67表示公众号/小程序/服务窗-综合，只需要填写产品码，例如65 |
